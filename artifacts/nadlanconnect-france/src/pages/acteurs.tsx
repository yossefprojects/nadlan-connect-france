...
function ActorCard({ name, desc, badge }: { name: string; desc: string; badge?: string }) {
  return (
    <div className="bg-white border border-gray-100 rounded-2xl p-5 hover:border-sea/30 hover:shadow-lg transition-all duration-300">
      <div className="flex items-start justify-between mb-3">
        <div className="w-10 h-10 bg-foreground/8 rounded-xl flex items-center justify-center">
          <span className="text-foreground font-black text-sm">{name.slice(0, 1)}</span>
        </div>
        {badge && <span className="px-2.5 py-0.5 rounded-full border border-sea/30 bg-amber-50 text-sea text-[10px] font-semibold">{badge}</span>}
      </div>
...
function LmnpCard({ name, sector, icon }: { name: string; sector: string; icon: string }) {
  return (
    <div className="bg-white border border-gray-100 rounded-xl p-4 hover:border-foreground/20 hover:shadow-sm transition-all flex items-start gap-3">
  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="flex items-center gap-3 mb-10">
            <div className="w-11 h-11 bg-foreground rounded-xl flex items-center justify-center shrink-0">
              <Building2 className="w-5 h-5 text-sea" />
            </div>
            <div>
              <p className="text-xs text-gray-400 uppercase tracking-widest mb-0.5">{t.promoteurs.eyebrow}</p>
              <h2 className="text-2xl font-black text-foreground">{t.promoteurs.title}</h2>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="flex items-center gap-3 mb-10">
            ...
            <div>
              ...
              <h2 className="text-2xl font-black text-foreground">{t.lmnp.title}</h2>
            </div>
          </div>
      ...
      <section className="py-12 md:py-20 bg-white border-t border-gray-100">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="flex items-center gap-3 mb-10">
            <div className="w-11 h-11 bg-foreground/15 rounded-xl flex items-center justify-center shrink-0">
              <Briefcase className="w-5 h-5 text-foreground" />
            </div>
            <div>
              <p className="text-xs text-gray-400 uppercase tracking-widest mb-0.5">{t.conseillers.eyebrow}</p>
              <h2 className="text-2xl font-black text-foreground">{t.conseillers.title}</h2>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-muted rounded-2xl p-8 border border-gray-100">
              <h3 className="font-bold text-foreground mb-3">{t.conseillers.platforms.title}</h3>
